class Author:
    ...
    def contracts(self):
        return [contract for contract in Contract.contracts_list if contract.author == self]
...
class Book:
    ...
    def contracts(self):
        return [contract for contract in Contract.contracts_list if contract.book == self]
...
class Contract:
    ...
    def contracts_by_date(cls, date):
        return sorted(
            [contract for contract in cls.contracts_list if contract.date == date],
